...
for o in range(0,Omega_expand_gap):
    ...
    E_cal_cum=E_cal_cum+E_calculate
...
ax_1.plot(place_hod,E_cal_cum.imag)
ax_2.plot(place_hod,E_plane_wave.imag)
ax_5.plot(place_hod,E_cal_cum.imag-E_plane_wave[:,0].imag)

ax_3.plot(place_hod,E_cal_cum.real)
ax_4.plot(place_hod,E_plane_wave.real)
ax_6.plot(place_hod,E_cal_cum.real-E_plane_wave[:,0].real)
